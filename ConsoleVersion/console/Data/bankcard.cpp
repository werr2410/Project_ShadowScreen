...
namespace ShadowScreen {
    ...
    Bankcard::Bankcard(QString number, QDate expirationDate):Bankcard("unknown",number,expirationDate){}

    Bankcard::Bankcard():Bankcard("unknown","unknown",QDate().currentDate()){}
    ...
    void Bankcard::setTitle(QString title)
        ...
        {
          if(expirationDate<QDate().currentDate()){return false;}
