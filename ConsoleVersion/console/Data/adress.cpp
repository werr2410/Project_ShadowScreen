...
namespace ShadowScreen {
    ...
    namespace Data {
        ...
        Adress::Adress(QString town, QString street, QString numberHouse):Adress("unknown",town,street,numberHouse){}

        Adress::Adress():Adress("unknown","unknown","unknown","unknown"){}
        ...
        bool Adress::operator<(const Adress &rhs) const
        {
            if(rhs.toString().length() > toString().length()) return true;
              else return false;
        }
