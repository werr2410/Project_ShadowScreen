...
public:
    ...
    void setupUi(QMainWindow *ShadowWindow)
    {
        ...
        label_username->setGeometry(QRect(863, 11, 81, 16));
        label_username->setStyleSheet(QString::fromUtf8("font: 700 10pt \"Segoe UI\";"));
        label_username_set = new QLabel(centralwidget);
        label_username_set->setObjectName("label_username_set");
        label_username_set->setGeometry(QRect(940, 10, 131, 16));
        ...
        label_review->setGeometry(QRect(1100, 10, 51, 20));
        label_review->setStyleSheet(QString::fromUtf8("font: 700 10pt \"Noto Sans\";"));
    ...
    void retranslateUi(QMainWindow *ShadowWindow)
    {
        ...
        textEdit_Seacrh->setPlaceholderText(QCoreApplication::translate("ShadowWindow", "Insert and push right button", nullptr));
        ...
        label_IMAGE_review->setText(QString());
        label_IMAGE_Seacrh->setText(QCoreApplication::translate("ShadowWindow", "Search", nullptr));
        label_IMAGE_myComputer->setText(QCoreApplication::translate("ShadowWindow", "My computer", nullptr));
        label_IMAGE_profile->setText(QCoreApplication::translate("ShadowWindow", "Profile", nullptr));
