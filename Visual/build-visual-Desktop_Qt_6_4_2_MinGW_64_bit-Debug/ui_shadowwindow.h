...
public:
    ...
    void setupUi(QMainWindow *ShadowWindow)
    {
        ...
        label_IMAGE_cpu_static = new QLabel(groupBox_2);
        label_IMAGE_cpu_static->setObjectName("label_IMAGE_cpu_static");
        label_IMAGE_cpu_static->setGeometry(QRect(280, 30, 100, 50));
        label_IMAGE_myComputer_3 = new QLabel(groupBox_2);
        label_IMAGE_myComputer_3->setObjectName("label_IMAGE_myComputer_3");
        label_IMAGE_myComputer_3->setGeometry(QRect(360, 70, 100, 50));
        ...
        label_IMAGE_gpu_static = new QLabel(groupBox_3);
        label_IMAGE_gpu_static->setObjectName("label_IMAGE_gpu_static");
        label_IMAGE_gpu_static->setGeometry(QRect(280, 30, 100, 50));
        ...
        label_IMAGE_storage_set = new QLabel(groupBox_4);
        label_IMAGE_storage_set->setObjectName("label_IMAGE_storage_set");
        label_IMAGE_storage_set->setGeometry(QRect(280, 30, 100, 50));
        ...
        label_IMAGE_memorychip_static = new QLabel(groupBox_5);
        label_IMAGE_memorychip_static->setObjectName("label_IMAGE_memorychip_static");
        label_IMAGE_memorychip_static->setGeometry(QRect(280, 30, 100, 50));
        ...
        label_IMAGE_myComputer_7 = new QLabel(groupBox_6);
        label_IMAGE_myComputer_7->setObjectName("label_IMAGE_myComputer_7");
        label_IMAGE_myComputer_7->setGeometry(QRect(280, 30, 100, 50));
        ...
        comboBox_Order->setGeometry(QRect(59, 60, 121, 21));
        ...
        pushButton_Telegram->setGeometry(QRect(870, 348, 401, 24));
    ...
    void retranslateUi(QMainWindow *ShadowWindow)
    {
        ...
        label_IMAGE_cpu_static->setText(QCoreApplication::translate("ShadowWindow", "Image ", nullptr));
        label_IMAGE_myComputer_3->setText(QCoreApplication::translate("ShadowWindow", "Image ", nullptr));
        ...
        label_IMAGE_gpu_static->setText(QCoreApplication::translate("ShadowWindow", "Image ", nullptr));
        ...
        label_IMAGE_storage_set->setText(QCoreApplication::translate("ShadowWindow", "Image ", nullptr));
        ...
        label_IMAGE_memorychip_static->setText(QCoreApplication::translate("ShadowWindow", "Image ", nullptr));
        ...
        label_IMAGE_myComputer_7->setText(QCoreApplication::translate("ShadowWindow", "Image ", nullptr));
        ...
        comboBox_Order->setItemText(0, QCoreApplication::translate("ShadowWindow", "No order", nullptr));
        comboBox_Order->setItemText(1, QCoreApplication::translate("ShadowWindow", "Stars", nullptr));
        comboBox_Order->setItemText(2, QCoreApplication::translate("ShadowWindow", "Manufacturer", nullptr));
        comboBox_Order->setItemText(3, QCoreApplication::translate("ShadowWindow", "isSale", nullptr));
        comboBox_Order->setItemText(4, QCoreApplication::translate("ShadowWindow", "Older User", nullptr));
