...
public:
    ...
    QLabel *label_Field1;
    QLabel *label_Field2;
    QTextEdit *textEdit_Mnufacturer;
    ...
    void setupUi(QDialog *DetailSetWindow)
    {
        ...
        DetailSetWindow->resize(528, 209);
        ...
        textEdit_Mnufacturer = new QTextEdit(DetailSetWindow);
        textEdit_Mnufacturer->setObjectName("textEdit_Mnufacturer");
        textEdit_Mnufacturer->setGeometry(QRect(99, 18, 184, 26));
        textEdit_Mnufacturer->setReadOnly(true);
        textEdit_Field1 = new QTextEdit(DetailSetWindow);
        textEdit_Field1->setObjectName("textEdit_Field1");
        textEdit_Field1->setGeometry(QRect(99, 65, 184, 26));
